(function ($) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Sin formación financiera", "Interés en aprender", "Falta de asesoría", "Desconfianza"],
        datasets: [
          {
            label: "Porcentaje (%)",
            data: [78, 82, 75, 68],
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: ["Sin seguimiento", "Riesgoso", "Falta claridad"],
        datasets: [
          {
            label: "Porcentaje (%)",
            data: [65, 60, 55], // Datos de la gráfica
            backgroundColor: "#D4AF37", // Color dorado
            borderColor: "#B49C73", // Color de borde
            borderWidth: 1,
          },
        ],
      },
